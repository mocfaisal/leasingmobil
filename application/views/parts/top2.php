...
<link href="<?php echo base_url() ?>assets/css/jquery.dataTables.css" rel="stylesheet" type="text/css" media="all">
<!-- Custom Theme files -->
...
<link href="<?php echo base_url(); ?>assets/css/ui-lightness/jquery-ui-1.10.4.css" rel="stylesheet">
<!--Google Fonts-->
...
<!-- geo chart -->
    ...
    <script>window.modernizr || document.write('<script src="<?php echo base_url() ?>assets/js/modernizr-custom.js"><\/script>')</script>
